...
| `imagesJson`         | `images-json`          | JSON string representation of images array for HTML attribute usage. Useful for server-side templates (e.g., Twig) that need to pass image data as strings. Will be parsed and converted to images array automatically.                                                   | `string`                                                       | `''`         |
