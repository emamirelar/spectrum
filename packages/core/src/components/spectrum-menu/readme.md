...
| Property           | Attribute           | Description                                                                                  | Type                                                                                                                                                        | Default        |
| ------------------ | ------------------- | -------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------- |
| `items`            | --                  | The menu items configuration icon: Material icon name (e.g. 'home', 'info', 'shopping_cart') | `{ label: string; href?: string; icon?: string; disabled?: boolean; children?: { label: string; href?: string; icon?: string; disabled?: boolean; }[]; }[]` | `[]`           |
| `mobileBreakpoint` | `mobile-breakpoint` | The breakpoint at which the menu switches to mobile view                                     | `number`                                                                                                                                                    | `768`          |
