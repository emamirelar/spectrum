...
<spectrum-menu
  ...
  variant="megamenu"
  mobile-breakpoint="768"
  megamenuFooterTitle="Our Sites"
  megamenuFooterTitleIcon="language"
  megamenuFooterItems='[
    {
      "label": "IATI Publisher",
      "href": "/publisher",
      "icon": "public"
    },
    {
      "label": "IATI Dashboard",
      "href": "/dashboard",
      "icon": "dashboard"
    },
    {
...
| `logoHref`                | `logo-href`                  | URL to navigate to when the logo is clicked When provided, the logo becomes a clickable link                                                                                                                                                 | `string`                                                                                                                                                                                                                                                                                                                   | `undefined`    |
| `logoLabel`               | `logo-label`                 | Accessible label for the logo Used for screen readers and ARIA labeling                                                                                                                                                                      | `string`                                                                                                                                                                                                                                                                                                                   | `'Home'`       |
| `megamenuFooterItems`     | `megamenu-footer-items`      | The megamenu footer items configuration (optional) Used for the footer section of megamenu variant Can be provided as a JSON string or array of objects                                                                                      | `string \| { label: string; href?: string; icon?: string; disabled?: boolean; }[]`                                                                                                                                                                                                                                         | `[]`           |
| `megamenuFooterTitle`     | `megamenu-footer-title`      | The megamenu footer title configuration (optional) Can be provided as a simple string or as a JSON string with text and icon                                                                                                                 | `string`                                                                                                                                                                                                                                                                                                                   | `''`           |
| `megamenuFooterTitleIcon` | `megamenu-footer-title-icon` | The megamenu footer title icon (optional) Material icon name to display with the footer title                                                                                                                                                | `string`                                                                                                                                                                                                                                                                                                                   | `''`           |
| `mobileBreakpoint`        | `mobile-breakpoint`          | The breakpoint at which the menu switches to mobile view                                                                                                                                                                                     | `number`                                                                                                                                                                                                                                                                                                                   | `768`          |
