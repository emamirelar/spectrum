...
<Meta title="Spectrum/Components/SpectrumImageGallery/Use Cases" />

# Image Gallery Use Cases

Real-world applications and business scenarios where Image Gallery components provide optimal user experience and drive measurable business outcomes.
...
**Use Cases Documentation** • [Component Dependencies](./spectrum-image-gallery-dependencies) • [API Reference](./README) • [Storybook Examples](./spectrum-image-gallery)