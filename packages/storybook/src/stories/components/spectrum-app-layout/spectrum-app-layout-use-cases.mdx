...
<Meta title="Spectrum/Layouts/SpectrumAppLayout/Use Cases" />

# App Layout Use Cases

Real-world applications and business scenarios where App Layout components provide optimal user experience and drive measurable business outcomes.
...
**Use Cases Documentation** • [Component Dependencies](./spectrum-app-layout-dependencies) • [API Reference](./README) • [Storybook Examples](./spectrum-app-layout)