...
<Meta title="Spectrum/Layouts/SpectrumContainer/Use Cases" />

# Container Use Cases

Real-world applications and business scenarios where Container components provide optimal user experience and drive measurable business outcomes.
...
**Use Cases Documentation** • [Component Dependencies](./spectrum-container-dependencies) • [API Reference](./README) • [Storybook Examples](./spectrum-container)