...
<Meta title="Spectrum/Layouts/SpectrumRailAlternative/Use Cases" />

# Rail Alternative Use Cases

Real-world applications and business scenarios where Rail Alternative components provide optimal user experience and drive measurable business outcomes.
...
**Use Cases Documentation** • [Component Dependencies](./spectrum-rail-alternative-dependencies) • [API Reference](./README) • [Storybook Examples](./spectrum-rail-alternative)