...
<Meta title="Spectrum/Layouts/SpectrumGrid/Use Cases" />

# Grid Use Cases

Real-world applications and business scenarios where Grid components provide optimal user experience and drive measurable business outcomes.
...
**Use Cases Documentation** • [Component Dependencies](./spectrum-grid-dependencies) • [API Reference](./README) • [Storybook Examples](./spectrum-grid)