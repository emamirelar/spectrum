...
<Meta title="Spectrum/Components/SpectrumSwitch/Use Cases" />

# Switch Use Cases

Real-world applications and business scenarios where Switch components provide optimal user experience and drive measurable business outcomes.
...
**Use Cases Documentation** • [Component Dependencies](./spectrum-switch-dependencies) • [API Reference](./README) • [Storybook Examples](./spectrum-switch)