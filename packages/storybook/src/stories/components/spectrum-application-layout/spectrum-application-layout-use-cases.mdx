...
<Meta title="Spectrum/Layouts/SpectrumApplicationLayout/Use Cases" />

# Application Layout Use Cases

Real-world applications and business scenarios where Application Layout components provide optimal user experience and drive measurable business outcomes.
...
**Use Cases Documentation** • [Component Dependencies](./spectrum-application-layout-dependencies) • [API Reference](./README) • [Storybook Examples](./spectrum-application-layout)