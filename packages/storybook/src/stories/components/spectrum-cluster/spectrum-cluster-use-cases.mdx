...
<Meta title="Spectrum/Layouts/SpectrumCluster/Use Cases" />

# Cluster Use Cases

Real-world applications and business scenarios where Cluster components provide optimal user experience and drive measurable business outcomes.
...
**Use Cases Documentation** • [Component Dependencies](./spectrum-cluster-dependencies) • [API Reference](./README) • [Storybook Examples](./spectrum-cluster)