...
<Meta title="Spectrum/Components/SpectrumToast/Use Cases" />

# Toast Use Cases

Real-world applications and business scenarios where Toast components provide optimal user experience and drive measurable business outcomes.
...
**Use Cases Documentation** • [Component Dependencies](./spectrum-toast-dependencies) • [API Reference](./README) • [Storybook Examples](./spectrum-toast)