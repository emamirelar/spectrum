...
<Meta title="Spectrum/Components/SpectrumWizard/Use Cases" />

# Wizard Use Cases

Real-world applications and business scenarios where Wizard components provide optimal user experience and drive measurable business outcomes.
...
**Use Cases Documentation** • [Component Dependencies](./spectrum-wizard-dependencies) • [API Reference](./README) • [Storybook Examples](./spectrum-wizard)