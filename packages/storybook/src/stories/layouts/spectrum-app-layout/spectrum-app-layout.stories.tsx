  ...
  render: (args: SpectrumAppLayoutArgs) => html`
    <div style="height: 600px; border: 2px dashed #ccc;">
      ...
      >
        ...
        <!-- Right bar content -->
        <div slot="right-bar" style="display: flex; flex-direction: column; gap: 1rem;">
          <div style="background: linear-gradient(135deg, #ff9800 0%, #f57c00 100%); padding: 1.5rem; border-radius: 8px; color: white; text-align: center;">
            <h4 style="margin: 0 0 0.5rem 0;">Wide Right Bar</h4>
            <p style="margin: 0; font-size: 0.875rem; opacity: 0.9;">18rem width when expanded</p>
          </div>
          <div style="display: flex; flex-direction: column; gap: 0.5rem;">
            <div style="padding: 1rem; background: rgba(255, 152, 0, 0.1); border-radius: 6px; border-left: 4px solid #ff9800;">Custom Tool 1</div>
            <div style="padding: 1rem; background: rgba(245, 124, 0, 0.1); border-radius: 6px; border-left: 4px solid #f57c00;">Custom Tool 2</div>
            <div style="padding: 1rem; background: rgba(255, 152, 0, 0.1); border-radius: 6px; border-left: 4px solid #ff9800;">Custom Tool 3</div>
          </div>
        </div>
        ...
        <div>
          ...
          <ul>
            ...
            <li>Right bar width: {args.rightBarWidth}</li>
    ...
    <div style="height: 600px; width: 100%; border: 2px dashed #ccc; position: relative; overflow: hidden;">
      ...
      >
        ...
        <div slot="sidebar" style="display: flex; flex-direction: column; gap: 1rem; padding: 1rem;">
          <div style="background: #e3f2fd; padding: 1rem; border-radius: 8px; text-align: center; border: 2px solid #2196f3;">
            <div style="font-size: 1.5rem; margin-bottom: 0.5rem;">📂</div>
            <div style="font-weight: bold; color: #1976d2; font-size: 1rem;">LEFT SIDEBAR</div>
            <div style="font-size: 0.8rem; color: #666; margin-top: 0.25rem;">Navigation</div>
          </div>
          
          <div style="display: flex; align-items: center; gap: 0.75rem; padding: 0.75rem; border-radius: 6px; cursor: pointer; background: #bbdefb;">
            <div style="width: 1.5rem; height: 1.5rem; background: #1976d2; border-radius: 4px; display: flex; align-items: center; justify-content: center; color: white;">🏠</div>
            <span style="font-weight: 500;">Home</span>
          </div>
          <div style="display: flex; align-items: center; gap: 0.75rem; padding: 0.75rem; border-radius: 6px; cursor: pointer; background: #f0f0f0;">
            <div style="width: 1.5rem; height: 1.5rem; background: #757575; border-radius: 4px; display: flex; align-items: center; justify-content: center; color: white;">📊</div>
            <span>Analytics</span>
          </div>
        </div>
        ...
        <div slot="right-bar" style="display: flex; flex-direction: column; gap: 1rem; padding: 1rem;">
          <div style="background: #f3e5f5; padding: 1rem; border-radius: 8px; text-align: center; border: 2px solid #9c27b0;">
            <div style="font-size: 1.5rem; margin-bottom: 0.5rem;">🔧</div>
            <div style="font-weight: bold; color: #7b1fa2; font-size: 1rem;">RIGHT BAR</div>
            <div style="font-size: 0.8rem; color: #666; margin-top: 0.25rem;">Tools & Properties</div>
          </div>
          
          <div style="display: flex; align-items: center; gap: 0.75rem; padding: 0.75rem; border-radius: 6px; cursor: pointer; background: #e1bee7;">
            <div style="width: 1.5rem; height: 1.5rem; background: #7b1fa2; border-radius: 4px; display: flex; align-items: center; justify-content: center; color: white;">🎨</div>
            <span style="font-weight: 500;">Properties</span>
          </div>
          <div style="display: flex; align-items: center; gap: 0.75rem; padding: 0.75rem; border-radius: 6px; cursor: pointer; background: #f0f0f0;">
        ...
        <div style="display: flex; flex-direction: column; gap: 1.5rem; height: 100%;">
          <div style="background: #e8f5e8; padding: 2rem; border-radius: 12px; text-align: center; border: 3px solid #4caf50;">
            <div style="font-size: 2rem; margin-bottom: 0.5rem;">📄</div>
            <h1 style="margin: 0; color: #2e7d32; font-size: 1.8rem; font-weight: bold;">THREE-PANEL LAYOUT</h1>
            <p style="color: #388e3c; margin: 0.5rem 0 0 0; font-size: 1rem;">Left sidebar + Main content + Right bar</p>
          </div>
          
          <div style="background: white; padding: 1.5rem; border-radius: 8px; border: 2px solid #ff9800; flex: 1;">
            <h2 style="margin: 0 0 1rem 0; color: #e65100;">🏗️ Right Bar Features</h2>
            <p style="margin-bottom: 1rem;">The right bar is perfect for:</p>
            <ul style="margin: 1rem 0; padding-left: 1.5rem; line-height: 1.8; color: #666;">
              <li><strong style="color: #9c27b0;">🎨 Properties Panel:</strong> Object properties, styling options</li>
              <li><strong style="color: #9c27b0;">🔧 Tool Palette:</strong> Design tools, action buttons</li>
              <li><strong style="color: #9c27b0;">📋 Layer Management:</strong> Content hierarchy, visibility controls</li>
              <li><strong style="color: #9c27b0;">📐 Inspector:</strong> Detailed information, debugging tools</li>
            </ul>
            <p style="color: #666; font-style: italic;">Click the toggle buttons (› and ‹) to collapse either panel!</p>
          </div>
        </div>
        ...
        <div slot="footer" style="display: flex; justify-content: space-between; align-items: center; width: 100%; padding: 0 1rem;">
          ...
          <span style="color: #666; font-size: 0.8rem;">Three-panel layout demo</span>
        </div>
      </spectrum-app-layout>
    </div>
  `
